...
public:
    ...
    static std::shared_ptr<const Open_curve_2>
    fit(const std::size_t order, const Polyline_2& ps,
...
private:
    ...
    explicit Open_curve_2(Internal::Unique_sisl_curve_ptr curve);
};
...
linearize(const Open_curve_2& c, const double tolerance = 1E-3);
